...
HWND BasicWindowMaker::createWindow(LPCWSTR p_title, LPCWSTR p_windowClass, int p_x, int p_y, int p_width,
...
{
	MyRegisterClass(p_hInst, p_wndProc, (wchar_t*)p_windowClass, classStyles, iconRc, iconSmallRc, menuRc);

	return InitInstance((wchar_t*)p_title, (wchar_t*)p_windowClass, p_x, p_y, p_width, p_height, p_hInst, exWindowStyles, windowStyles, p_nCmdShow, parent);
}

HWND BasicWindowMaker::createBasicBtn(HWND parentHwnd, HINSTANCE hInst, int x, int y, int w, int h, LPCWSTR text, int extraStyles, int identifier)
{
...
HWND BasicWindowMaker::createBasicEc(HWND parentHwnd, HINSTANCE hInst, int x, int y, int w, int h, LPCWSTR text, int extraStyles, int identifier)
{
...
ATOM MyRegisterClass(HINSTANCE hInstance, WNDPROC p_wndProc, wchar_t* p_windowClass, int classStyles, int iconRc, int iconSmallRc, int menuRc)
{
	WNDCLASSEXW wcex;
